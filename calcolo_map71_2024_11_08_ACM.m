...
% Calcola la mappa
% Emap = calcola_mappa_E_fitting('./dati/map71.txt', slope, k, R, v, n, p);
Emap = calcola_mappa_E_intervallo('./dati/map71.txt', slope, k, R, v, n, Rsq_min);
% Rendi in MPa
Emap = Emap / 1e6;
...
mostra_mappa_E(Emap, L, 'MPa', 'Distribuzione modulo elastico ACM-EXP84');
