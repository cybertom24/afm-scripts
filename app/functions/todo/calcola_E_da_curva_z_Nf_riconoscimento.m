...
% background.
function [E, Erid, u_E, U_Erid] = calcola_E_da_curva_z_Nf_riconoscimento(z, Nf, slope, k, R, v, n)
    ...
    [E, Erid, u_E, U_Erid] = calcola_E_modH_lineare_riconoscimento(z * 1e-9, d * 1e-9, k, R, v, n);
end