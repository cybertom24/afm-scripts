function [Emap, uEmap] = calcola_mappa_E_riconoscimento(file, slope, k, r, v, n)
    ...
    for i = 1:1:dim
        for j = 1:1:dim
            curva = (i-1)*dim + j;
            [Emap(i,j), ~, uEmap(i,j)] = calcola_E_da_curva_z_Nf_riconoscimento(z, Nf_list(:, curva), slope, k, r, v, n);
        end
    end
end 