...
name = salva_Emap(Emap, out_dir, k, R, v, n, Rsq_min, b_start, 'L', L, 'um', 'MPa', 'name', 'acm exp111 p1');
...
% Calcola la mappa, convertendo i valori in MPa
Emap = calculate_E_map('./dati/exp111/map50.txt', slope, k, R, v, n, Rsq_min, b_start) * 1e-6;
name = salva_Emap(Emap, out_dir, k, R, v, n, Rsq_min, b_start, 'L', L, 'um', 'MPa', 'name', 'acm exp111 p2');
...
% Calcola la mappa, convertendo i valori in MPa
Emap = calculate_E_map('./dati/exp111/map53.txt', slope, k, R, v, n, Rsq_min, b_start) * 1e-6;
name = salva_Emap(Emap, out_dir, k, R, v, n, Rsq_min, b_start, 'L', L, 'um', 'MPa', 'name', 'acm exp111 p3');
...
% Calcola la mappa, convertendo i valori in MPa
Emap = calculate_E_map('./dati/exp111/map55.txt', slope, k, R, v, n, Rsq_min, b_start) * 1e-6;
name = salva_Emap(Emap, out_dir, k, R, v, n, Rsq_min, b_start, 'L', L, 'um', 'MPa', 'name', 'acm exp111 p4');
