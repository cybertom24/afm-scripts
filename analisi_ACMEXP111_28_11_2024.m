...
[Emap, ~, z_1, good_curves] = calculate_E_map('./dati/exp111/map48.txt', slope, k, R, v, n, Rsq_min, 0.80);
Emap = Emap * 1e-6;
...
h1 = histogram(Emap, 'DisplayName', 'E', 'BinWidth', bin_size, 'Normalization', 'count', 'Visible', 'off');
Emap1 = Emap;

%% --- P2 (50.43; 50.89): img49, map50 ---

% Calcola la mappa, convertendo i valori in MPa
[Emap, ~, z, good_curves] = calculate_E_map('./dati/exp111/map50.txt', slope, k, R, v, n, Rsq_min, b_start);
Emap = Emap * 1e-6;
...
% Calcola la mappa, convertendo i valori in MPa
[Emap, ~, z, good_curves] = calculate_E_map('./dati/exp111/map53.txt', slope, k, R, v, n, Rsq_min, b_start);
Emap = Emap * 1e-6;
...
% Calcola la mappa, convertendo i valori in MPa
[Emap, ~, z, good_curves] = calculate_E_map('./dati/exp111/map55.txt', slope, k, R, v, n, Rsq_min, b_start);
Emap = Emap * 1e-6;
...
hold on;
legend show;
title('Mean force distance curves on ACM-EXP111');
xlabel('z [nm]');
ylabel('F [nN]');

z_1 = z_1 * 1e9;
z = z * 1e9;
plot(z_1, mean_curve_1 * k * 1e9, 'DisplayName', 'P_1');
...
%salva_mappa_come_vettore(Emap1, './output/analisi exp111/acm-exp111-P1-400pt-MPa-0.5Nm.csv');
%salva_mappa_come_vettore(Emap2, './output/analisi exp111/acm-exp111-P2-400pt-MPa-0.5Nm.csv');
%salva_mappa_come_vettore(Emap3, './output/analisi exp111/acm-exp111-P3-400pt-MPa-0.5Nm.csv');
%salva_mappa_come_vettore(Emap4, './output/analisi exp111/acm-exp111-P4-400pt-MPa-0.5Nm.csv');
% salva_mappa_come_vettore([Emap1, Emap2, Emap3, Emap4], './output/csv/acm-exp111-1600pt-MPa.csv');